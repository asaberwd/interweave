...
var interweaveEmoji = require('interweave-emoji');
...
var GROUPS = [emojibase.GROUP_KEY_SMILEYS_EMOTION, emojibase.GROUP_KEY_PEOPLE_BODY, emojibase.GROUP_KEY_COMPONENT, emojibase.GROUP_KEY_ANIMALS_NATURE, emojibase.GROUP_KEY_FOOD_DRINK, emojibase.GROUP_KEY_TRAVEL_PLACES, emojibase.GROUP_KEY_ACTIVITIES, emojibase.GROUP_KEY_OBJECTS, emojibase.GROUP_KEY_SYMBOLS, emojibase.GROUP_KEY_FLAGS];
var GROUP_ICONS = (_GROUP_ICONS = {}, _GROUP_ICONS[GROUP_KEY_COMMONLY_USED] = '🕑', _GROUP_ICONS[emojibase.GROUP_KEY_SMILEYS_EMOTION] = '😃', _GROUP_ICONS[emojibase.GROUP_KEY_PEOPLE_BODY] = '👍', _GROUP_ICONS[emojibase.GROUP_KEY_ANIMALS_NATURE] = '🌿', _GROUP_ICONS[emojibase.GROUP_KEY_FOOD_DRINK] = '🍎', _GROUP_ICONS[emojibase.GROUP_KEY_TRAVEL_PLACES] = '🗺️', _GROUP_ICONS[emojibase.GROUP_KEY_ACTIVITIES] = '⚽️', _GROUP_ICONS[emojibase.GROUP_KEY_OBJECTS] = '📘', _GROUP_ICONS[emojibase.GROUP_KEY_SYMBOLS] = '⛔️', _GROUP_ICONS[emojibase.GROUP_KEY_FLAGS] = '🏴', _GROUP_ICONS);
var SKIN_KEY_NONE = 'none';
var SKIN_TONES = [SKIN_KEY_NONE, emojibase.SKIN_KEY_LIGHT, emojibase.SKIN_KEY_MEDIUM_LIGHT, emojibase.SKIN_KEY_MEDIUM, emojibase.SKIN_KEY_MEDIUM_DARK, emojibase.SKIN_KEY_DARK];
var SKIN_COLORS = (_SKIN_COLORS = {}, _SKIN_COLORS[SKIN_KEY_NONE] = '#FFCC22', _SKIN_COLORS[emojibase.SKIN_KEY_LIGHT] = '#FADCBC', _SKIN_COLORS[emojibase.SKIN_KEY_MEDIUM_LIGHT] = '#E0BB95', _SKIN_COLORS[emojibase.SKIN_KEY_MEDIUM] = '#BF8F68', _SKIN_COLORS[emojibase.SKIN_KEY_MEDIUM_DARK] = '#9B643D', _SKIN_COLORS[emojibase.SKIN_KEY_DARK] = '#5A463A', _SKIN_COLORS);
...
var Context = React__default.createContext({
  ...
  emojiSource: {
    compact: false,
    locale: 'en',
    version: interweaveEmoji.LATEST_DATASET_VERSION
  },
...
function EmojiListHeader(_ref) {
  ...
  var showPalette = skinTonePalette && (group === emojibase.GROUP_KEY_PEOPLE_BODY || group === GROUP_KEY_SEARCH_RESULTS || group === GROUP_KEY_NONE);
  ...
  }, React__default.createElement("span", null, group === GROUP_KEY_COMMONLY_USED ? messages[camelCase(commonMode)] : messages[camelCase(group)]), showPalette && skinTonePalette, showClear && React__default.createElement("button", {
    type: "button",
...
function Emoji(_ref) {
  ...
  }, React__default.createElement(interweaveEmoji.Emoji, {
    emojiPath: emojiPath,
    emojiSize: emojiSize,
...
function EmojiListRow(_ref) {
  ...
  }, Array.isArray(row) ? React__default.createElement("div", {
  ...
  })) : React__default.createElement(EmojiListHeader, {
    clearIcon: clearIcon,
...
function EmojiList(_ref) {
  ...
  React.useEffect(function () {
    ...
    Object.keys(groupedEmojis).forEach(function (group) {
      ...
      if (group === emojibase.GROUP_KEY_COMPONENT) {
        return;
      }
  ...
  return React__default.createElement("div", {
  ...
  }, React__default.createElement(reactWindow.FixedSizeList, {
    ref: ref,
    ...
    return React__default.createElement(EmojiListRow, _extends({}, rowProps, props));
  }), stickyGroupHeader && activeGroup !== GROUP_KEY_NONE && React__default.createElement(EmojiListHeader, _extends({}, rowProps, {
    sticky: true,
    group: activeGroup
  })));
}
...
function SkinTonePalette(_ref) {
  ...
  return React__default.createElement("nav", {
    ...
    return React__default.createElement("li", {
      key: skinTone
    }, React__default.createElement(SkinTone, {
...
function GroupTabs(_ref) {
  ...
  var groups = GROUPS.filter(function (group) {
    return group !== emojibase.GROUP_KEY_COMPONENT;
  });
...
function PreviewBar(_ref) {
  ...
  if (!emoji) {
    ...
    }, preview && React__default.createElement("div", {
  ...
  }, formatTitle(title), emoji.skins && emoji.skins.length > 0 && React__default.createElement("span", {
    className: classNames.previewShiftMore
  }, "(+", emoji.skins.length, ")")), subtitle.length > 0 && React__default.createElement("div", {
...
var InternalPicker = function (_React$PureComponent) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClear", function () {
      if (_this.state.activeGroup === GROUP_KEY_VARIATIONS) {
        _this.setUpdatedState({
          activeGroup: _this.state.searchQuery ? GROUP_KEY_SEARCH_RESULTS : emojibase.GROUP_KEY_SMILEYS_EMOTION
        }, true);
      } else {
        _this.setUpdatedState({
          commonEmojis: []
  ...
  _proto.getActiveGroup = function getActiveGroup(hasCommon) {
    ...
    if (group === GROUP_KEY_COMMONLY_USED) {
      ...
      group = emojibase.GROUP_KEY_SMILEYS_EMOTION;
    }
  ...
  _proto.render = function render() {
    ...
    var skinTones = disableSkinTones ? null : React__default.createElement(SkinTonePalette, {
      key: "skin-tones",
      activeSkinTone: activeSkinTone,
      icons: skinIcons,
    ...
    var components = {
      emojis: React__default.createElement(EmojiList, _extends({
        key: "emojis"
      }, virtual, {
      ...
      groups: disableGroups ? null : React__default.createElement(GroupTabs, {
        key: "groups",
        activeGroup: activeGroup,
        commonEmojis: commonEmojis,
        commonMode: commonMode,
      ...
      preview: disablePreview ? null : React__default.createElement(PreviewBar, {
        key: "preview",
        emoji: activeEmoji,
      ...
      search: disableSearch ? null : React__default.createElement(SearchBar, {
        key: "search",
        autoFocus: autoFocus,
...
_defineProperty(InternalPicker, "defaultProps", {
  ...
  maxCommonlyUsed: 30,
  maxEmojiVersion: interweaveEmoji.MAX_EMOJI_VERSION,
  messages: {},
  noPreview: null,
  noResults: null,
...
function Picker(_ref4) {
  ...
  var _useEmojiData = interweaveEmoji.useEmojiData({
    compact: compact,
    locale: locale,
  ...
  return React__default.createElement(InternalPicker, _extends({}, props, {
    emojis: emojis,
    emojiData: data,
    emojiSource: source
  }));
...
Object.defineProperty(exports, 'GROUP_KEY_ACTIVITIES', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_ACTIVITIES;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_ANIMALS_NATURE', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_ANIMALS_NATURE;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_COMPONENT', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_COMPONENT;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_FLAGS', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_FLAGS;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_FOOD_DRINK', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_FOOD_DRINK;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_OBJECTS', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_OBJECTS;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_PEOPLE_BODY', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_PEOPLE_BODY;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_SMILEYS_EMOTION', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_SMILEYS_EMOTION;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_SYMBOLS', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_SYMBOLS;
  }
});
Object.defineProperty(exports, 'GROUP_KEY_TRAVEL_PLACES', {
  enumerable: true,
  get: function () {
    return emojibase.GROUP_KEY_TRAVEL_PLACES;
  }
});
Object.defineProperty(exports, 'SKIN_KEY_DARK', {
  enumerable: true,
  get: function () {
    return emojibase.SKIN_KEY_DARK;
  }
});
Object.defineProperty(exports, 'SKIN_KEY_LIGHT', {
  enumerable: true,
  get: function () {
    return emojibase.SKIN_KEY_LIGHT;
  }
});
Object.defineProperty(exports, 'SKIN_KEY_MEDIUM', {
  enumerable: true,
  get: function () {
    return emojibase.SKIN_KEY_MEDIUM;
  }
});
Object.defineProperty(exports, 'SKIN_KEY_MEDIUM_DARK', {
  enumerable: true,
  get: function () {
    return emojibase.SKIN_KEY_MEDIUM_DARK;
  }
});
Object.defineProperty(exports, 'SKIN_KEY_MEDIUM_LIGHT', {
  enumerable: true,
  get: function () {
    return emojibase.SKIN_KEY_MEDIUM_LIGHT;
  }
});
...
exports.GROUP_KEY_VARIATIONS = GROUP_KEY_VARIATIONS;
